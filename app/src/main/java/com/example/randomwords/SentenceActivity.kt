...
class SentenceActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val wiseadapter = ListviewApater(wiseSayingList)
        val listView = findViewById<ListView>(R.id.wiseListView)

        listView.adapter = wiseadapter

        supportActionBar?.title = "Wiseword List"
